...
<section class="hero card"><p class="eyebrow">Secure QR workflows</p><h1>Create production-ready QR codes in seconds.</h1><p>Generate trackable QR codes for registration, payments, events, and custom landing pages with a local Node.js API and file storage.</p><a class="button" routerLink="/create">Create QR Code</a></section>
